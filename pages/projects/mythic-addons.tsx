    ...
    return (
        <div className={styles.container}>
            ...
            <main>
                ...
                <br />
                <div className="bg-black bg-opacity-60 rounded p-4">
                <p className="text-2xl text-center">
                    A <a href="https://github.com/gnembon/fabric-carpet">Fabric-Carpet</a> Extension Focused on Optimizing Certain Parts of the Game 
                </p>
                <h3>
                ...
                <ul>
                    ...
                    <li>
                        oldFlintAndSteel — allows you to update observers with Flint & Steel 
                    </li>
                    <li>
