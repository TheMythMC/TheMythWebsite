  ...
  return (
    <div className={styles.container}>
      ...
      <main>
        ...
        <div className="bg-black rounded p-4 bg-opacity-60">
          ...
          <p>
            ...
            <h4 className="text-lg p-3">
              <ul>
                <li>
                  <a href="/projects/serversync">
                    Server-Sync — A Server-Discord bridge mod that Focuses on performance 
                  </a>
                </li>
                <li>
                  <a href="/projects/mythic-addons">
                    MythicAddons — A carpet extension adding things that
                    should(n&apos;t) be in the main game but aren&apos;t{" "}
                  </a>
                </li>
                <li>
                  <a href="projects/barium">Barium</a> — An auto-updater focused
            ...
            <h4 className="text-lg">
              <ul>
                <li>
                  ...
                  <a href="https://github.com/cardboardpowered/cardboard">
                    {" "}
                    Cardboard{" "}
                  </a>
